...
const stats = [
  { icon: <DollarSign className="text-green-600 text-2xl" />, value: '₹50L', label: 'Max Loan', bgColor: 'from-green-500/10 to-emerald-500/10', borderColor: 'border-green-200 dark:border-green-800', textColor: 'text-green-700 dark:text-green-400' },
  { icon: <Clock className="text-blue-600 text-2xl" />, value: '3 Days', label: 'Avg. Disbursal', bgColor: 'from-blue-500/10 to-indigo-500/10', borderColor: 'border-blue-200 dark:border-blue-800', textColor: 'text-blue-700 dark:text-blue-400' },
...
const features = [
  { icon: <DollarSign className="text-primary-600 text-2xl" />, title: '₹1 lakh to ₹50 lakh', desc: 'Finance your dream car with competitive loan amounts.' },
  { icon: <Clock className="text-primary-600 text-2xl" />, title: '1 to 7 years tenure', desc: 'Flexible repayment periods for new and used cars.' },
  { icon: <CheckCircle className="text-primary-600 text-2xl" />, title: '100% on-road price', desc: 'Finance up to 100% of your car\'s on-road price.' },
  { icon: <Shield className="text-primary-600 text-2xl" />, title: 'Quick approval', desc: 'Get approved and disbursed within 3 working days.' },
  { icon: <TrendingUp className="text-primary-600 text-2xl" />, title: 'Minimal documentation', desc: 'Simple application process with minimal paperwork.' },
  { icon: <User className="text-primary-600 text-2xl" />, title: 'Used car financing', desc: 'Special financing options for pre-owned vehicles.' },
];
    ...
    <section className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 py-0 flex flex-col items-center justify-center relative overflow-x-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-8 pt-20 pb-10 flex flex-col md:flex-row items-center gap-10 md:gap-0">
        ...
        <div className="flex-1 flex flex-col items-start justify-center md:pr-12">
          ...
          >
            Calculate your monthly EMI, total interest, and total payment for your car loan. Drive your dream car home today with our smart calculator!
          </motion.p>
          <motion.button
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="mb-8 text-center">
            <div className="flex items-center justify-center gap-3 mb-2">
              ...
              <h2 className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-primary-600 to-success-600 bg-clip-text text-transparent tracking-tight">Car Loan EMI Calculator</h2>
            </div>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">Calculate your monthly EMI, total interest, and total payment for your car loan. Adjust the sliders or enter values to see instant results!</p>
          </div>
      ...
      <section className="relative w-full py-16 bg-gradient-to-b from-primary-50 via-white to-green-50 dark:from-primary-900 dark:via-white/10 dark:to-green-900/10 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div className="text-lg md:text-xl font-bold text-gray-800 dark:text-gray-100 mb-2">Nayi car chahiye? Car loan se apna sapna puriye!</div>
          <div className="text-gray-700 dark:text-gray-300 text-lg mb-2">Car loan se aap nayi ya purani car easily khareed sakte hain – quick approval, flexible tenure, aur hassle-free process ke saath.</div>
          <div className="text-gray-700 dark:text-gray-300 text-lg mb-2">Electric vehicles, luxury cars, ya budget-friendly options – sab ke liye car loan available hai.</div>
          <div className="text-gray-700 dark:text-gray-300 text-lg mb-6">Apply karein, car drive karein, FundRoot ke saath!</div>
          ...
          <div className="text-gray-700 dark:text-gray-300 text-lg mb-8">Car loans available at attractive interest rates starting from <span className="font-semibold text-primary-700">7.5% p.a.</span> (final rate depends on your eligibility and car model).</div>
        </div>
      </section>
    </section>
  );
