...
import { PieChart, CreditCard, User, DollarSign, BarChart2, TrendingUp, Shield, CheckCircle, Star, Clock, ArrowRight, Building2, Briefcase, TrendingDown, Calculator, FileText } from 'lucide-react';
...
const stats = [
  { icon: <DollarSign className="text-green-600 text-2xl" />, value: '₹1Cr', label: 'Max Loan', bgColor: 'from-green-500/10 to-emerald-500/10', borderColor: 'border-green-200 dark:border-green-800', textColor: 'text-green-700 dark:text-green-400' },
  { icon: <Clock className="text-blue-600 text-2xl" />, value: '72 Hrs', label: 'Avg. Disbursal', bgColor: 'from-blue-500/10 to-indigo-500/10', borderColor: 'border-blue-200 dark:border-blue-800', textColor: 'text-blue-700 dark:text-blue-400' },
  ...
  { icon: <Building2 className="text-purple-600 text-2xl" />, value: '5K+', label: 'Businesses', bgColor: 'from-purple-500/10 to-pink-500/10', borderColor: 'border-purple-200 dark:border-purple-800', textColor: 'text-purple-700 dark:text-purple-400' },
];

const features = [
  { icon: <DollarSign className="text-primary-600 text-2xl" />, title: '₹1 lakh to ₹1 crore', desc: 'Business loan amounts for every growth stage.' },
  { icon: <Clock className="text-primary-600 text-2xl" />, title: '1 to 7 years tenure', desc: 'Flexible repayment for your business needs.' },
  { icon: <CheckCircle className="text-primary-600 text-2xl" />, title: 'Collateral-free', desc: 'No security required for most business loans.' },
  { icon: <Shield className="text-primary-600 text-2xl" />, title: 'Quick approval', desc: 'Fast processing with minimal documentation.' },
  { icon: <TrendingUp className="text-primary-600 text-2xl" />, title: 'Working capital', desc: 'Finance your daily business operations.' },
  { icon: <Briefcase className="text-primary-600 text-2xl" />, title: 'Multiple lenders', desc: 'Choose from top banks & NBFCs.' },
];

const useCases = [
  { icon: <TrendingUp className="text-blue-600 text-2xl" />, title: 'Business Expansion', desc: 'Expand operations and market reach' },
  { icon: <Building2 className="text-green-600 text-2xl" />, title: 'Working Capital', desc: 'Manage cash flow and daily operations' },
  { icon: <Briefcase className="text-purple-600 text-2xl" />, title: 'Equipment Purchase', desc: 'Buy machinery and technology' },
  { icon: <FileText className="text-orange-600 text-2xl" />, title: 'Inventory Management', desc: 'Stock up on raw materials' },
  { icon: <TrendingDown className="text-pink-600 text-2xl" />, title: 'Debt Consolidation', desc: 'Combine multiple business loans' },
  { icon: <DollarSign className="text-indigo-600 text-2xl" />, title: 'Marketing Campaign', desc: 'Promote your business aggressively' },
];

const benefits = [
  'No collateral required for loans up to ₹50 lakh',
  'Fast approval and disbursal within 72 hours',
  'Flexible repayment options with moratorium period',
  'Balance transfer facility available',
  'Tax benefits on interest paid',
  '24/7 online tracking and support',
];
...
const BusinessLoanEMICalculator: React.FC = () => {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 py-0 flex flex-col items-center justify-center relative overflow-x-hidden">
      ...
      {[{ Icon: TrendingUp, delay: 0, position: 'top-20 left-10' }, { Icon: Building2, delay: 0.5, position: 'top-32 right-16' }, { Icon: CheckCircle, delay: 1, position: 'bottom-40 left-20' }].map(({ Icon, delay, position }, index) => (
        <motion.div
          key={index}
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-8 pt-20 pb-10 flex flex-col md:flex-row items-center gap-10 md:gap-0">
        ...
        <div className="flex-1 flex flex-col items-start justify-center md:pr-12">
          ...
          >
            Calculate your monthly EMI, total interest, and total payment for your business loan. Scale your business with confidence using our smart calculator!
          </motion.p>
          <motion.button
          ...
          >
            ...
            <div className="w-full flex flex-col gap-2 mt-auto">
              <div className="flex justify-between text-xs text-gray-500">
                <span>Revenue</span>
                <span className="text-green-600 font-bold">₹5,00,000</span>
              </div>
              <div className="flex justify-between text-xs text-gray-500">
                <span>Expenses</span>
                <span className="text-red-500 font-bold">₹2,00,000</span>
              </div>
              <div className="flex justify-between text-xs text-gray-500">
                <span>Net Profit</span>
                <span className="text-primary-600 font-bold">₹3,00,000</span>
              </div>
            </div>
      ...
      {/* Use Cases Section - EXTRA */}
      <section className="relative w-full py-16 bg-gradient-to-b from-white via-blue-50 to-purple-50 dark:from-gray-900 dark:via-blue-900/10 dark:to-purple-900/10 overflow-hidden">
        <div className="relative z-10 max-w-7xl mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-4 bg-gradient-to-r from-primary-600 to-success-600 bg-clip-text text-transparent tracking-tight">How Can You Use Business Loan?</h2>
          <p className="text-xl text-center text-gray-600 dark:text-gray-300 mb-12">Flexible funding for all your business needs</p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {useCases.map((useCase, index) => (
              ...
              >
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-4 mb-4 group-hover:scale-110 transition-transform duration-300 inline-block">
                  {useCase.icon}
                </div>
                <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-2">{useCase.title}</h3>
      ...
      {/* Key Benefits - EXTRA */}
      <section className="relative w-full py-16 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900/10 overflow-hidden">
        <div className="relative z-10 max-w-7xl mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-12 bg-gradient-to-r from-primary-600 to-success-600 bg-clip-text text-transparent tracking-tight">Key Benefits</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="mb-8 text-center">
            <div className="flex items-center justify-center gap-3 mb-2">
              ...
              <h2 className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-primary-600 to-success-600 bg-clip-text text-transparent tracking-tight">Business Loan EMI Calculator</h2>
            </div>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">Calculate your monthly EMI, total interest, and total payment for your business loan. Adjust the sliders or enter values to see instant results!</p>
          </div>
      ...
      <section className="relative w-full py-16 bg-gradient-to-b from-primary-50 via-white to-green-50 dark:from-primary-900 dark:via-white/10 dark:to-green-900/10 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div className="text-lg md:text-xl font-bold text-gray-800 dark:text-gray-100 mb-2">Business grow karein, FundRoot ke saath!</div>
          <div className="text-gray-700 dark:text-gray-300 text-lg mb-2">Business loan se aap apna business asaani se finance kar sakte hain – expansion, working capital, equipment, ya koi bhi business need ke liye.</div>
          <div className="text-gray-700 dark:text-gray-300 text-lg mb-2">Startup, SME, ya established business – sab ke liye business loan available hai.</div>
          <div className="text-gray-700 dark:text-gray-300 text-lg mb-6">Apply karein, business grow karein, FundRoot ke saath!</div>
          ...
          <div className="text-gray-700 dark:text-gray-300 text-lg mb-8">Business loans available at attractive interest rates starting from <span className="font-semibold text-primary-700">9% p.a.</span> (final rate depends on your business profile and eligibility).</div>
        </div>
      </section>
    </section>
  );
