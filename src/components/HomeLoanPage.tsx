...
const stats = [
  { icon: <FaRupeeSign className="text-green-600 dark:text-green-400 text-2xl" />, value: '₹2Cr+', label: 'Loans Processed' },
  { icon: <Users className="text-blue-600 dark:text-blue-400 text-2xl" />, value: '15K+', label: 'Happy Home Owners' },
  { icon: <Star className="text-yellow-600 dark:text-yellow-400 text-2xl" />, value: '4.8★', label: 'Google Rating' },
  { icon: <Clock className="text-purple-600 dark:text-purple-400 text-2xl" />, value: '48 Hrs', label: 'Avg. Disbursal' },
];

const features = [
  { icon: <FaRupeeSign className="text-white text-3xl" />, title: '₹5 lakh to ₹2 crore', desc: 'Home loan amounts for every dream home.' },
  { icon: <FaRegClock className="text-white text-3xl" />, title: '5 to 30 years tenure', desc: 'Long-term, flexible repayment.' },
  { icon: <FaCheckCircle className="text-white text-3xl" />, title: 'Low interest rates', desc: 'Attractive rates for home buyers.' },
  { icon: <FaUserShield className="text-white text-3xl" />, title: 'Secure process', desc: 'Safe, transparent, and reliable.' },
  { icon: <FaBolt className="text-white text-3xl" />, title: 'Quick approval', desc: 'Fast processing for your dream home.' },
  { icon: <FaHome className="text-white text-3xl" />, title: 'Balance transfer', desc: 'Transfer your existing home loan easily.' },
];

const faqs = [
  {
    question: 'Home loan lene ke liye minimum salary kitni honi chahiye?',
    answer: 'Generally, minimum monthly salary ₹25,000-₹30,000 honi chahiye, lekin yeh bank/lender par depend karta hai.'
  },
  {
    question: 'Home loan lene me kitna time lagta hai?',
    answer: 'Agar documents sahi hain toh 3-7 din me approval aur disbursal ho sakta hai.'
  },
  {
    question: 'Kya collateral ya guarantor chahiye?',
    answer: 'Home loan me aapka ghar hi collateral hota hai.'
  },
  {
    question: 'Kya main apna home loan online apply kar sakta hoon?',
    ...
    <section className="bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                Get the best rates and quick approval for your new home. <span className="font-semibold text-primary-600 dark:text-primary-400">Low EMI, long tenure, expert support.</span>
              </motion.p>
              {/* CTA Buttons */}
              <motion.div
            ...
            >
              <div className="relative bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-2xl p-6 w-[340px] h-[620px] flex flex-col items-center border border-gray-100 dark:border-gray-800 animate-fade-in">
                ...
                <div className="w-full h-36 rounded-xl overflow-hidden mb-4 flex items-center justify-center bg-gray-100 dark:bg-gray-800">
                  <img src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=400&q=80" alt="Home" className="object-cover w-full h-full" />
                </div>
                {/* Feature Grid */}
                <div className="grid grid-cols-2 gap-4 w-full mt-2">
                  ...
                  <div className="flex flex-col items-center bg-blue-50 dark:bg-primary-900/10 rounded-xl p-4 shadow-sm">
                    <FaHome className="text-primary-700 text-2xl mb-1" />
                    <span className="text-sm font-semibold text-gray-700 dark:text-gray-200">Home Specialist</span>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section className="w-full py-14 bg-gradient-to-b from-white via-green-50 to-blue-50 dark:from-gray-900 dark:via-green-900/10 dark:to-blue-900/10">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-14 bg-gradient-to-r from-primary-600 to-success-600 bg-clip-text text-transparent tracking-tight">How Home Loans Work</h2>
      ...
      <section className="relative w-full px-4 md:px-8 mb-16">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div className="text-lg md:text-xl font-bold text-gray-800 dark:text-gray-100 mb-2">Dream home kharidne ke liye paise ki zarurat hai?</div>
          <div className="text-gray-700 dark:text-gray-300 text-lg mb-2">Home loan se aap apna ghar asaani se finance kar sakte hain, woh bhi kam interest rate par aur lambi tenure ke saath.</div>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
            <div>
              <h2 className="text-4xl md:text-5xl font-extrabold mb-4 bg-gradient-to-r from-primary-600 to-success-600 bg-clip-text text-transparent flex items-center gap-2">
                <FaCalculator className="text-primary-600" /> Home Loan EMI Calculator
              </h2>
