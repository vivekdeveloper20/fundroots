...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-gray-900 to-black text-white">
      ...
      <div className="max-w-7xl mx-auto py-16">
        <div className="grid lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            {/* Newsletter Signup */}
            <div className="bg-gradient-to-r from-primary-500/10 to-success-500/10 backdrop-blur-sm border border-primary-500/20 rounded-2xl p-6">
              <h3 className="text-xl font-semibold mb-3">Stay Updated</h3>
              <p className="text-gray-300 mb-4">Get the latest financial tips and loan updates</p>
              <div className="flex gap-2">
                <input
                  type="email"
                  placeholder="Enter your email"
                  className="flex-1 bg-white/10 border border-white/20 rounded-lg px-4 py-2 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500"
                />
                <motion.button
                  className="bg-gradient-to-r from-primary-500 to-success-500 px-4 py-2 rounded-lg hover:from-primary-600 hover:to-success-600 transition-all duration-300"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
      ...
      >
        <motion.button
          className="bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-2xl flex items-center gap-3 group"
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          animate={{ y: [0, -5, 0] }}
        ...
        >
          ...
          <span className="hidden group-hover:block animate-slide-up">Chat with us</span>
        </motion.button>
      </motion.div>
    </footer>
  );
