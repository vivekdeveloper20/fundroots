...
const stats = [
  { icon: <FaRupeeSign className="text-green-600 dark:text-green-400 text-2xl" />, value: '₹1Cr+', label: 'Loans Processed' },
  { icon: <Users className="text-blue-600 dark:text-blue-400 text-2xl" />, value: '5K+', label: 'Businesses Funded' },
  { icon: <Star className="text-yellow-600 dark:text-yellow-400 text-2xl" />, value: '4.7★', label: 'Google Rating' },
  { icon: <Clock className="text-purple-600 dark:text-purple-400 text-2xl" />, value: '72 Hrs', label: 'Avg. Disbursal' },
];

const features = [
  { icon: <FaRupeeSign className="text-white text-3xl" />, title: '₹1 lakh to ₹1 crore', desc: 'Business loan amounts for every growth stage.' },
  { icon: <FaRegClock className="text-white text-3xl" />, title: '1 to 5 years tenure', desc: 'Flexible repayment for your business.' },
  { icon: <FaCheckCircle className="text-white text-3xl" />, title: 'Collateral-free', desc: 'No security required for most loans.' },
  { icon: <FaUserShield className="text-white text-3xl" />, title: 'Quick process', desc: 'Fast approval and minimal paperwork.' },
  { icon: <FaBolt className="text-white text-3xl" />, title: 'Instant disbursal', desc: 'Funds in your account within days.' },
  { icon: <FaBriefcase className="text-white text-3xl" />, title: 'Multiple lenders', desc: 'Choose from top banks & NBFCs.' },
];

const faqs = [
  {
    question: 'Business loan lene ke liye business kitna purana hona chahiye?',
    answer: 'Generally, business ko kam se kam 1 saal purana hona chahiye, lekin yeh lender par depend karta hai.'
  },
  {
    question: 'Business loan lene me kitna time lagta hai?',
    answer: 'Agar documents sahi hain toh 2-5 din me approval aur disbursal ho sakta hai.'
  },
  {
    question: 'Kya collateral ya guarantor chahiye?',
    answer: 'Bahut saare business loans collateral-free hote hain, lekin kuch cases me security mangi ja sakti hai.'
  },
  {
    question: 'Kya main apna business loan online apply kar sakta hoon?',
    answer: 'Haan, aap pura process online kar sakte hain.'
  },
];

const BusinessLoanPage: React.FC = () => {
    ...
    <section className="bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                Get the best rates and quick approval for your business needs. <span className="font-semibold text-primary-600 dark:text-primary-400">Low EMI, flexible tenure, expert support.</span>
              </motion.p>
              {/* CTA Buttons */}
              <motion.div
            ...
            >
              <div className="relative bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-2xl p-6 w-[340px] h-[620px] flex flex-col items-center border border-gray-100 dark:border-gray-800 animate-fade-in">
                ...
                <div className="flex flex-col items-center mb-4">
                  ...
                  <div className="mt-2 px-4 py-1 rounded-full bg-primary-50 text-primary-700 font-semibold text-sm shadow">Business Loan</div>
                </div>
                {/* Image */}
                <div className="w-full h-36 rounded-xl overflow-hidden mb-4 flex items-center justify-center bg-gray-100 dark:bg-gray-800">
                  <img src="https://images.unsplash.com/photo-1515168833906-d2a3b82b3029?auto=format&fit=crop&w=400&q=80" alt="Business" className="object-cover w-full h-full" />
                </div>
                {/* Feature Grid */}
      ...
      <section className="w-full py-14 bg-gradient-to-b from-white via-green-50 to-blue-50 dark:from-gray-900 dark:via-green-900/10 dark:to-blue-900/10">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-14 bg-gradient-to-r from-primary-600 to-success-600 bg-clip-text text-transparent tracking-tight">How Business Loans Work</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-6 items-start">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="text-gray-500 text-base font-medium">Fill a simple form with your details and business info.</div>
            </div>
            {/* Step 2 */}
            <div className="flex flex-col items-center text-center">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="text-gray-500 text-base font-medium">Submit KYC, income, and business documents online.</div>
            </div>
            {/* Step 4 */}
            <div className="flex flex-col items-center text-center">
              <div className="w-20 h-20 rounded-full bg-green-100 flex items-center justify-center mb-3 shadow-lg">
              ...
              <div className="text-gray-500 text-base font-medium">Loan amount is credited to your account for business expansion.</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-b from-primary-50 to-white dark:from-primary-900/10 dark:to-gray-900/10 w-full px-4 md:px-8">
        <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-10 bg-gradient-to-r from-primary-600 to-success-600 bg-clip-text text-transparent tracking-tight">Why Choose Our Business Loan?</h2>
      ...
      <section className="relative w-full px-4 md:px-8 mb-16">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold mb-4 bg-gradient-to-r from-primary-600 to-success-600 bg-clip-text text-transparent">What is Business Loan?</h2>
          <div className="text-lg md:text-xl font-bold text-gray-800 dark:text-gray-100 mb-2">Business growth karein, FundRoot ke saath!</div>
          <div className="text-gray-700 dark:text-gray-300 text-lg mb-2">Business loan se aap apna business asaani se finance kar sakte hain, woh bhi kam interest rate par aur lambi tenure ke saath.</div>
          ...
          <div className="text-gray-700 dark:text-gray-300 text-lg mb-8">Business loans available at attractive interest rates starting from <span className="font-semibold text-primary-700">16% p.a.</span> (final rate depends on your eligibility).</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-8">
            ...
            <div className="group flex flex-col items-center bg-primary-50 dark:bg-primary-900/20 rounded-xl p-6 shadow transition-all duration-200 hover:shadow-xl hover:-translate-y-1 cursor-pointer">
              ...
              <div className="font-extrabold text-lg text-primary-700 mb-1">Up to ₹1 crore</div>
              <div className="w-8 h-1 rounded-full bg-gradient-to-r from-primary-400 to-success-400 opacity-30 mb-2"></div>
            ...
            <div className="group flex flex-col items-center bg-primary-50 dark:bg-primary-900/20 rounded-xl p-6 shadow transition-all duration-200 hover:shadow-xl hover:-translate-y-1 cursor-pointer">
              ...
              <div className="font-extrabold text-lg text-primary-700 mb-1">Up to 5 Years</div>
              <div className="w-8 h-1 rounded-full bg-gradient-to-r from-primary-400 to-success-400 opacity-30 mb-2"></div>
          ...
          <div className="mt-4 bg-green-50 dark:bg-green-900/20 rounded-lg p-4 flex items-center gap-3">
            ...
            <span className="text-gray-800 dark:text-gray-100 text-base">Did you know? Business loans offer tax benefits under Section 80C and 24(b) of the Income Tax Act!</span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1 bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg rounded-3xl shadow-xl flex flex-col md:flex-row items-center gap-8 p-10 border border-primary-100 dark:border-primary-900">
            ...
            <div className="flex-1">
              ...
              <div className="text-primary-600 font-medium mb-4">Check if you qualify for a business loan in seconds!</div>
              <ul className="space-y-3 text-gray-800 dark:text-gray-100 text-lg mb-3">
                ...
                <li className="flex items-center gap-2"><FaBriefcase className="text-primary-600" /> Any business entity (proprietorship, partnership, LLP, private limited, etc.)</li>
          ...
          <div className="flex-1 bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg rounded-3xl shadow-xl flex flex-col md:flex-row items-center gap-8 p-10 border border-success-100 dark:border-success-900">
            ...
            <div className="flex-1">
              ...
              <ul className="space-y-3 text-gray-800 dark:text-gray-100 text-lg mb-3">
                ...
                <li className="flex items-center gap-2"><FaHome className="text-success-600" /> Business documents</li>
              </ul>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
            <div>
              <h2 className="text-4xl md:text-5xl font-extrabold mb-4 bg-gradient-to-r from-primary-600 to-success-600 bg-clip-text text-transparent flex items-center gap-2">
                <FaCalculator className="text-primary-600" /> Business Loan EMI Calculator
              </h2>
              <p className="text-gray-600 dark:text-gray-300 text-lg max-w-2xl">Calculate your monthly EMI, total interest, and total payment for your business loan. Adjust the sliders or enter values to see instant results!</p>
            </div>
            ...
            <div className="flex-1 bg-gradient-to-br from-primary-50 via-white to-success-50 dark:from-primary-900 dark:via-gray-900 dark:to-success-900 rounded-2xl p-6 flex flex-col gap-8 shadow-md">
              ...
              <div className="flex flex-col gap-1 mb-2">
                ...
                <div className="flex items-center gap-4">
                  <input type="range" min="100000" max="10000000" step="10000" value={amount} onChange={e => setAmount(Number(e.target.value))} className="w-full accent-primary-600 h-3 md:h-4" style={{ accentColor: '#17607d' }} />
                  <input type="number" min="100000" max="10000000" step="10000" value={amount} onChange={e => setAmount(Number(e.target.value))} className="w-32 rounded border px-3 py-2 dark:bg-gray-900 dark:border-gray-700 text-right font-semibold" />
                </div>
                <div className="flex justify-between text-xs text-gray-500 dark:text-gray-400 mt-3 px-1">
                  <span>₹1L</span>
                  <span className="font-semibold text-primary-700 dark:text-primary-300">₹{(100000 + (10000000-100000)/2).toLocaleString()}</span>
                  <span>₹1Cr</span>
                </div>
              ...
              <div className="flex flex-col gap-1 mb-2">
                ...
                <div className="flex items-center gap-4">
                  <input type="range" min="10" max="20" step="0.1" value={rate} onChange={e => setRate(Number(e.target.value))} className="w-full accent-success-600 h-3 md:h-4" style={{ accentColor: '#22c55e' }} />
                  <input type="number" min="10" max="20" step="0.1" value={rate} onChange={e => setRate(Number(e.target.value))} className="w-20 rounded border px-3 py-2 dark:bg-gray-900 dark:border-gray-700 text-right font-semibold" />
                </div>
                <div className="flex justify-between text-xs text-gray-500 dark:text-gray-400 mt-3 px-1">
                  <span>10%</span>
                  <span className="font-semibold text-success-700 dark:text-success-300">{((10+20)/2).toFixed(1)}%</span>
                  <span>20%</span>
                </div>
                <div className="text-center mt-2 mb-1">
