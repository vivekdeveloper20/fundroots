...
import { FaRupeeSign, FaRegClock, FaCheckCircle, FaUserShield, FaBolt, FaMobileAlt, FaCalculator, FaFileAlt, FaUserTie, FaPercentage, FaCalendarAlt, FaWallet, FaUserCheck, FaIdCard, FaHome, FaFileInvoiceDollar, FaUniversity, FaRegImage, FaBriefcase, FaStar, FaCar } from 'react-icons/fa';
import { TrendingUp, Shield, Users, Star, Clock, ArrowRight, Calculator, CheckCircle } from 'lucide-react';

const stats = [
  { icon: <FaRupeeSign className="text-green-600 dark:text-green-400 text-2xl" />, value: '₹50Cr+', label: 'Loans Processed' },
  { icon: <Users className="text-blue-600 dark:text-blue-400 text-2xl" />, value: '8K+', label: 'Cars Funded' },
  { icon: <FaStar className="text-yellow-600 dark:text-yellow-400 text-2xl" />, value: '4.9★', label: 'Google Rating' },
  { icon: <FaRegClock className="text-purple-600 dark:text-purple-400 text-2xl" />, value: '24 Hrs', label: 'Avg. Disbursal' },
];

const features = [
  { icon: <FaRupeeSign className="text-white text-3xl" />, title: '₹50,000 to ₹50 lakh', desc: 'Car loan amounts for new & used cars.' },
  { icon: <FaRegClock className="text-white text-3xl" />, title: '1 to 7 years tenure', desc: 'Flexible repayment for your car.' },
  { icon: <FaCheckCircle className="text-white text-3xl" />, title: 'Up to 100% funding', desc: 'Get full on-road price financed.' },
  { icon: <FaUserShield className="text-white text-3xl" />, title: 'Quick process', desc: 'Fast approval and minimal paperwork.' },
  { icon: <FaBolt className="text-white text-3xl" />, title: 'Instant disbursal', desc: 'Funds in your account within hours.' },
  { icon: <FaCar className="text-white text-3xl" />, title: 'New & Used Cars', desc: 'Loan for both new and pre-owned cars.' },
];

const faqs = [
  {
    question: 'Car loan lene ke liye minimum salary kitni honi chahiye?',
    answer: 'Generally, minimum monthly salary ₹15,000-₹20,000 honi chahiye, lekin yeh bank/lender par depend karta hai.'
  },
  {
    question: 'Car loan lene me kitna time lagta hai?',
    answer: 'Agar documents sahi hain toh 1-3 din me approval aur disbursal ho sakta hai.'
  },
  {
    question: 'Kya down payment zaruri hai?',
    answer: 'Kuch banks 100% funding dete hain, lekin aksar 10-20% down payment lag sakta hai.'
  },
  {
    question: 'Kya main apna car loan online apply kar sakta hoon?',
    answer: 'Haan, aap pura process online kar sakte hain.'
  },
];

const CarLoanPage: React.FC = () => {
    ...
    <section className="bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                Get the best rates and quick approval for your new or used car. <span className="font-semibold text-primary-600 dark:text-primary-400">Low EMI, flexible tenure, expert support.</span>
              </motion.p>
              {/* CTA Buttons */}
              <motion.div
              ...
              >
                {stats.map((stat, index) => (
                  <motion.div 
                    key={index} 
                    className={`relative group bg-gradient-to-br from-green-500/10 to-emerald-500/10 backdrop-blur-sm border border-green-200 dark:border-green-800 rounded-2xl p-4 text-center hover:scale-105 hover:shadow-xl transition-all duration-300 cursor-pointer`}
                    whileHover={{ y: -5 }}
                  ...
                  >
                    {/* Glow effect */}
                    <div className={`absolute inset-0 bg-gradient-to-br from-green-500/10 to-emerald-500/10 rounded-2xl blur-xl opacity-0 group-hover:opacity-50 transition-opacity duration-300`}></div>
                    {/* Content */}
                    <div className="relative z-10">
                      ...
                      {/* Value */}
                      <div className={`text-2xl md:text-3xl font-extrabold text-green-700 dark:text-green-400 mb-1 group-hover:scale-110 transition-transform duration-300`}> {stat.value} </div>
                      {/* Label */}
                      <div className="text-xs md:text-sm font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wide"> {stat.label} </div>
                      {/* Animated underline */}
                      <div className={`w-0 group-hover:w-full h-0.5 bg-gradient-to-r from-green-500/50 to-emerald-500/50 transition-all duration-300 mx-auto mt-2`}></div>
                    </div>
                  </motion.div>
                ))}
              </motion.div>
            ...
            >
              <div className="relative bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-2xl p-6 w-[340px] h-[620px] flex flex-col items-center border border-gray-100 dark:border-gray-800 animate-fade-in">
                ...
                <div className="flex flex-col items-center mb-4">
                  ...
                  <div className="mt-2 px-4 py-1 rounded-full bg-primary-50 text-primary-700 font-semibold text-sm shadow">Car Loan</div>
                </div>
                {/* Image */}
                <div className="w-full h-36 rounded-xl overflow-hidden mb-4 flex items-center justify-center bg-gray-100 dark:bg-gray-800">
                  <img src="https://images.unsplash.com/photo-1503736334956-4c8f8e92946d?auto=format&fit=crop&w=400&q=80" alt="Car" className="object-cover w-full h-full" />
                </div>
                {/* Feature Grid */}
                <div className="grid grid-cols-2 gap-4 w-full mt-2">
                  ...
                  <div className="flex flex-col items-center bg-blue-50 dark:bg-primary-900/10 rounded-xl p-4 shadow-sm">
                    <FaCar className="text-primary-700 text-2xl mb-1" />
                    <span className="text-sm font-semibold text-gray-700 dark:text-gray-200">Car Specialist</span>
                  </div>
                </div>
              </div>
            </motion.div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4">
          ...
          <style>{`
            ...
            @media (max-width: 768px) {
              ...
              .animate-scroll-left { animation-duration: 6s; }
            }
          `}</style>
        </div>
      </section>

      {/* How Home Loans Work - Modern with Icons/Graphics */}
      <section className="w-full py-14 bg-gradient-to-b from-white via-green-50 to-blue-50 dark:from-gray-900 dark:via-green-900/10 dark:to-blue-900/10">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-14 bg-gradient-to-r from-primary-600 to-success-600 bg-clip-text text-transparent tracking-tight">How Car Loans Work</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-6 items-start">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="text-gray-500 text-base font-medium">Fill a simple form with your details and property info.</div>
            </div>
            {/* Step 2 */}
            <div className="flex flex-col items-center text-center">
              ...
              <div className="text-gray-500 text-base font-medium">Application is reviewed and approved in a few days.</div>
            </div>
            {/* Step 3 */}
            <div className="flex flex-col items-center text-center">
              <div className="w-20 h-20 rounded-full bg-blue-100 flex items-center justify-center mb-3 shadow-lg">
              ...
              <div className="text-gray-500 text-base font-medium">Submit KYC, income, and property documents online.</div>
            </div>
            {/* Step 4 */}
            <div className="flex flex-col items-center text-center">
              <div className="w-20 h-20 rounded-full bg-green-100 flex items-center justify-center mb-3 shadow-lg">
              ...
              <div className="text-gray-500 text-base font-medium">Loan amount is credited to your account for home purchase.</div>
            </div>
          </div>
        </div>
      </section>

      {/* Why Choose Our Home Loan? Section */}
      <section className="py-16 bg-gradient-to-b from-primary-50 to-white dark:from-primary-900/10 dark:to-gray-900/10 w-full px-4 md:px-8">
        <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-10 bg-gradient-to-r from-primary-600 to-success-600 bg-clip-text text-transparent tracking-tight">Why Choose Our Car Loan?</h2>
      ...
      {/* What is Home Loan Section - Modern, Informative, Creative */}
      <section className="relative w-full px-4 md:px-8 mb-16">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold mb-4 bg-gradient-to-r from-primary-600 to-success-600 bg-clip-text text-transparent">What is Car Loan?</h2>
          <div className="text-lg md:text-xl font-bold text-gray-800 dark:text-gray-100 mb-2">Dream car kharidne ke liye paise ki zarurat hai?</div>
          <div className="text-gray-700 dark:text-gray-300 text-lg mb-2">Car loan se aap apna ghar asaani se finance kar sakte hain, woh bhi kam interest rate par aur lambi tenure ke saath.</div>
          <div className="text-gray-700 dark:text-gray-300 text-lg mb-2">Nayi property, resale, ya construction – sab ke liye home loan available hai.</div>
          <div className="text-gray-700 dark:text-gray-300 text-lg mb-6">Apne sapno ka ghar hasil karein, FundRoot ke saath!</div>
          ...
          <div className="text-gray-700 dark:text-gray-300 text-lg mb-8">Home loans available at attractive interest rates starting from <span className="font-semibold text-primary-700">8.5% p.a.</span> (final rate depends on your eligibility).</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-8">
            ...
            <div className="group flex flex-col items-center bg-primary-50 dark:bg-primary-900/20 rounded-xl p-6 shadow transition-all duration-200 hover:shadow-xl hover:-translate-y-1 cursor-pointer">
              ...
              <div className="font-extrabold text-lg text-primary-700 mb-1">Up to 1%</div>
            ...
            <div className="group flex flex-col items-center bg-primary-50 dark:bg-primary-900/20 rounded-xl p-6 shadow transition-all duration-200 hover:shadow-xl hover:-translate-y-1 cursor-pointer">
              ...
              <div className="font-extrabold text-lg text-primary-700 mb-1">Up to ₹2 crore</div>
              <div className="w-8 h-1 rounded-full bg-gradient-to-r from-primary-400 to-success-400 opacity-30 mb-2"></div>
            ...
            <div className="group flex flex-col items-center bg-primary-50 dark:bg-primary-900/20 rounded-xl p-6 shadow transition-all duration-200 hover:shadow-xl hover:-translate-y-1 cursor-pointer">
              ...
              <div className="font-extrabold text-lg text-primary-700 mb-1">Up to 30 Years</div>
              <div className="w-8 h-1 rounded-full bg-gradient-to-r from-primary-400 to-success-400 opacity-30 mb-2"></div>
            ...
            <div className="group flex flex-col items-center bg-primary-50 dark:bg-primary-900/20 rounded-xl p-6 shadow transition-all duration-200 hover:shadow-xl hover:-translate-y-1 cursor-pointer">
              ...
              <div className="w-8 h-1 rounded-full bg-gradient-to-r from-primary-400 to-success-400 opacity-30 mb-2"></div>
              <div className="text-primary-500 text-sm">Buy, build, or renovate</div>
            </div>
          </div>
          ...
          <div className="mt-4 bg-green-50 dark:bg-green-900/20 rounded-lg p-4 flex items-center gap-3">
            ...
            <span className="text-gray-800 dark:text-gray-100 text-base">Did you know? Home loans offer tax benefits under Section 80C and 24(b) of the Income Tax Act!</span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1 bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg rounded-3xl shadow-xl flex flex-col md:flex-row items-center gap-8 p-10 border border-primary-100 dark:border-primary-900">
            ...
            <div className="flex-1">
              ...
              <div className="text-primary-600 font-medium mb-4">Check if you qualify for a home loan in seconds!</div>
              <ul className="space-y-3 text-gray-800 dark:text-gray-100 text-lg mb-3">
                <li className="flex items-center gap-2"><FaUserTie className="text-primary-600" /> Indian resident, age 21–65 years</li>
                <li className="flex items-center gap-2"><FaBriefcase className="text-primary-600" /> Salaried or self-employed</li>
                <li className="flex items-center gap-2"><FaRupeeSign className="text-primary-600" /> Stable income source</li>
                <li className="flex items-center gap-2"><FaStar className="text-primary-600" /> Good credit score preferred</li>
          ...
          <div className="flex-1 bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg rounded-3xl shadow-xl flex flex-col md:flex-row items-center gap-8 p-10 border border-success-100 dark:border-success-900">
            ...
            <div className="flex-1">
              ...
              <ul className="space-y-3 text-gray-800 dark:text-gray-100 text-lg mb-3">
                ...
                <li className="flex items-center gap-2"><FaHome className="text-success-600" /> Property documents</li>
              </ul>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
            <div>
              <h2 className="text-4xl md:text-5xl font-extrabold mb-4 bg-gradient-to-r from-primary-600 to-success-600 bg-clip-text text-transparent flex items-center gap-2">
                <FaCalculator className="text-primary-600" /> Car Loan EMI Calculator
              </h2>
              <p className="text-gray-600 dark:text-gray-300 text-lg max-w-2xl">Calculate your monthly EMI, total interest, and total payment for your home loan. Adjust the sliders or enter values to see instant results!</p>
            </div>
            ...
            <div className="flex-1 bg-gradient-to-br from-primary-50 via-white to-success-50 dark:from-primary-900 dark:via-gray-900 dark:to-success-900 rounded-2xl p-6 flex flex-col gap-8 shadow-md">
              ...
              <div className="flex flex-col gap-1 mb-2">
                ...
                <div className="flex items-center gap-4">
                  <input type="range" min="100000" max="20000000" step="10000" value={amount} onChange={e => setAmount(Number(e.target.value))} className="w-full accent-primary-600 h-3 md:h-4" style={{ accentColor: '#17607d' }} />
                  <input type="number" min="100000" max="20000000" step="10000" value={amount} onChange={e => setAmount(Number(e.target.value))} className="w-32 rounded border px-3 py-2 dark:bg-gray-900 dark:border-gray-700 text-right font-semibold" />
                </div>
                <div className="flex justify-between text-xs text-gray-500 dark:text-gray-400 mt-3 px-1">
                  <span>₹1L</span>
                  <span className="font-semibold text-primary-700 dark:text-primary-300">₹{(100000 + (20000000-100000)/2).toLocaleString()}</span>
                  <span>₹2Cr</span>
                </div>
              ...
              <div className="flex flex-col gap-1 mb-2">
                ...
                <div className="flex items-center gap-4">
                  <input type="range" min="7" max="12" step="0.1" value={rate} onChange={e => setRate(Number(e.target.value))} className="w-full accent-success-600 h-3 md:h-4" style={{ accentColor: '#22c55e' }} />
                  <input type="number" min="7" max="12" step="0.1" value={rate} onChange={e => setRate(Number(e.target.value))} className="w-20 rounded border px-3 py-2 dark:bg-gray-900 dark:border-gray-700 text-right font-semibold" />
                </div>
                <div className="flex justify-between text-xs text-gray-500 dark:text-gray-400 mt-3 px-1">
                  <span>7%</span>
                  <span className="font-semibold text-success-700 dark:text-success-300">{((7+12)/2).toFixed(1)}%</span>
                  <span>12%</span>
                </div>
                <div className="text-center mt-2 mb-1">
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="flex items-center gap-4">
                  <input type="range" min="12" max="360" step="1" value={tenure} onChange={e => setTenure(Number(e.target.value))} className="w-full accent-primary-600 h-3 md:h-4" style={{ accentColor: '#17607d' }} />
                  <input type="number" min="12" max="360" step="1" value={tenure} onChange={e => setTenure(Number(e.target.value))} className="w-20 rounded border px-3 py-2 dark:bg-gray-900 dark:border-gray-700 text-right font-semibold" />
                </div>
                <div className="flex justify-between text-xs text-gray-500 dark:text-gray-400 mt-3 px-1">
                  <span>12</span>
                  <span className="font-semibold text-primary-700 dark:text-primary-300">{Math.round((12+360)/2)}</span>
                  <span>360</span>
                </div>
                <div className="text-center mt-2 mb-1">
